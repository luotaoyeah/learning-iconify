...
// https://docs.iconify.design/icon-components/bundles/vue.html
// https://docs.iconify.design/icon-components/bundles/examples/component-simple.html
...
const target = 'src/icons.ts';

// Icons to bundle, array
const iconsToBundle = ['mdi:check-network'];

// Organize icons by prefix
const sortedIcons = organizeIconsList(iconsToBundle);

// Load icons data
let output = commonJS ? "const { addCollection } = require('" + component + "');\n\n" : "import { addCollection } from '" + component + "';\n\n";
...
console.log(`图标生成成功: ${target} (${output.length} bytes)`);
